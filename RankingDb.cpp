...
void RankingApp::RankingDb::populateTables()
{
  ...
  tc.createTableAndResetCreator(TAB_RANKING_CLASS);
  ...
  tc.addForeignKey(VA_RANK_CLASS_REF, TAB_RANKING_CLASS, CONSISTENCY_ACTION::RESTRICT);
  ...
  tc.addForeignKey(SC_RANK_CLASS_REF, TAB_RANKING_CLASS, CONSISTENCY_ACTION::RESTRICT);
...
void RankingApp::RankingDb::dropAndCreateRankingTab()
{
  ...
  tc.addForeignKey(RA_RANK_CLASS_REF, TAB_RANKING_CLASS, CONSISTENCY_ACTION::RESTRICT);
